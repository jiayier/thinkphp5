...
class Excel1
{
    ...
    public function import($path){
        Loader::import('PHPExcel18.classes.PHPExcel');
        Loader::import('PHPExcel18.classes.PHPExcel.PHPExcel_IOFactory');
    ...
    public function export($data,$obj,$name,$type='xls'){
        ...
        try {
            ...
            $objPHPExcel = $obj->dataFormat($data, $objPHPExcel);//数据格式处理
            if ($type == 'xls') {//文件后缀处理
